...
CREATE TABLE IF NOT EXISTS "public"."order_items" (
    ...
    "qunatity" integer DEFAULT 1 NOT NULL,
...
CREATE POLICY "Allow authenticated users to SELECT" ON "public"."products" TO "authenticated", "anon" USING (true) WITH CHECK (true);
...
with check ((bucket_id = 'product-images'::text));
  ...
  create policy "Allow authenticated users to read  16wiy3a_1"
  on "storage"."objects"
  as permissive
  for select
  to authenticated
